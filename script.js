...
function updateTotalPrice() {
  ...
  const totalSelectedPriceHTML = `${totalSelectedPriceFormatted}<img src="${coinImageUrl}" style="width: 28px; height: 28px;"><span style="display: inline-block; width: 10px;"></span>${totalSelectedPriceInItemsFormatted}<img src="${
  ...
  if (getIsPriceShownInScreenshot()) {
    if (!isInPriceCalculationMode && shouldShowTotalInNormalMode) {
      ...
      const totalPriceHTML = `${totalPriceFormatted}<img src="${coinImageUrl}" style="width: 28px; height: 28px;"><span style="display: inline-block; width: 10px;"></span>${totalPriceInItemsFormatted}<img src="${
        priceCalculationItem.url
      }" style="width: 28px; height: 28px;"><span style="display: inline-block; width: 10px;"></span>(${itemCountFormatted} item${
        itemCount === 1 ? "" : "s"
      })`;
